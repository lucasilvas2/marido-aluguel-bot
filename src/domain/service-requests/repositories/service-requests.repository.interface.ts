...
export abstract class ServiceRequestsRepositoryInterface {
    abstract create(clientId: number, professionalId: number, specialtyId: number, status: string, description: string): Promise<ServiceRequest>;
    abstract findById(id: number): Promise<ServiceRequest | null>;
    abstract update(id: number, clientId: number, professionalId: number, specialtyId: number, status: string, description: string): Promise<ServiceRequest>;
